...
1.  [`preregistration.md`]: Preregistration document that details the plans for the study. Preregistrations are time-stamped using Git version control. Go to the [`Git Tags page`](https://github.com/StefanVermeent/WMC/tags) of this project to see a full time-stamped list of all preregistrations and other major milestones of the project (e.g., potential deviations from preregistrations).
