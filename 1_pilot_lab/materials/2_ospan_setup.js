...
var ospan_midpoint_accuracy = {  
     type: 'html-keyboard-response',
     stimulus: function(){
       stim = "<div style='font-size:20px;'>Tot nu toe heb je <font color='blue'>"+Math.round((overall_acc/trial_count)*100)+" %</font> van de rekensommen correct opgelost.</div><br><br><br>";
       stim += "Probeer meer je tijd te nemen op de resterende rekensommen om je accuratesse te verhogen.<br><br>";
       stim += "Druk op het pijltje naar links (&larr;) or het pijltje naar rechts (&rarr;) om door te gaan naar het volgende blok.";
